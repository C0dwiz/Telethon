...
def get_import_code(tlobject):
    ...
    return 'from herokutl.tl.{}{} import {}'\
            ...
            if tlobject.is_function:
                ...
                if tlobject.friendly:
                    ...
                    docs.write_text(
                        ...
                        'https://docs.herokutl.dev/en/stable/modules/client.html'
                        '#herokutl.client.{0}.{1}"><code>client.{1}()</code></a> '
                ...
                docs.write('''<pre>\
<strong>from</strong> herokutl.sync <strong>import</strong> TelegramClient
<strong>from</strong> herokutl <strong>import</strong> functions, types
