...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        Members:
            messages (Sequence[`Message <herokutl.tl.custom.message.Message>`]):
        ...
        async def get_reply_message(self):
            """
            The `Message <herokutl.tl.custom.message.Message>`
        ...
        async def reply(self, *args, **kwargs):
            ...
            for `herokutl.client.messages.MessageMethods.send_message`
