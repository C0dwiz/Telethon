...
class CallbackQuery(EventBuilder):
    ...
    def build(cls, update, others=None, self_id=None):
        if isinstance(update, types.UpdateBotCallbackQuery):
            ...
            # See https://github.com/LonamiWebs/herokutl/pull/1005
    ...
    class Event(EventCommon, SenderGetter):
        ...
        async def respond(self, *args, **kwargs):
            ...
            `herokutl.client.messages.MessageMethods.send_message` with
            ``entity`` already set.
        ...
        async def edit(self, *args, **kwargs):
            ...
            `herokutl.client.messages.MessageMethods.edit_message` with
            ...
            .. note::
                ...
                `Message.edit <herokutl.tl.custom.message.Message.edit>`,
