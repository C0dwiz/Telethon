...
class ChatAction(EventBuilder):
    ...
    * Whenever a user is removed or leaves a group if it has
    ...
    class Event(EventCommon):
        ...
        Members:
            action_message  (`MessageAction <https://tl.herokutl.dev/types/message_action.html>`_):
        ...
        async def get_pinned_message(self):
            ...
            <herokutl.tl.custom.message.Message>` object that was pinned.
            """
        ...
        async def get_pinned_messages(self):
            ...
            <herokutl.tl.custom.message.Message>` objects that were pinned.
            """
