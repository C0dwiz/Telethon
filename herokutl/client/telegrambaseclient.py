...
class TelegramBaseClient(abc.ABC):
    ...
    Arguments
        session (`str` | `herokutl.sessions.abstract.Session`, `None`):
        ...
        connection (`herokutl.network.connection.common.Connection`, optional):
            The connection instance to be used when creating a new connection
            to the servers. It **must** be a type.

            Defaults to `herokutl.network.connection.tcpfull.ConnectionTcpFull`.
        ...
        raise_last_call_error (`bool`, optional):
            When API calls fail in a way that causes herokutl to retry
        ...
        app_version (`str`, optional):
            ...
            Defaults to `herokutl.version.__version__`.
    ...
    def __init__(
        ...
        if not api_id or not api_hash:
            raise ValueError(
                ...
                "Refer to herokutl.rtfd.io for more information.")
        ...
        #
        # See https://github.com/LonamiWebs/herokutl/issues/1337 for details.
        if not callable(getattr(self.loop, 'sock_connect', None)):
            raise TypeError(
                ...
                '# https://github.com/LonamiWebs/herokutl/issues/1337\n'
                'import asyncio\n'
    ...
    async def connect(self: 'TelegramClient') -> None:
        ...
        .. note::
            ...
            request, like `client.get_me() <herokutl.client.users.UserMethods.get_me>`,
    ...
    def __call__(self: 'TelegramClient', request, ordered=False):
        ...
        Args:
            ...
            flood_sleep_threshold (`int` | `None`, optional):
                ...
                `client.flood_sleep_threshold <herokutl.client.telegrambaseclient.TelegramBaseClient.flood_sleep_threshold>`
