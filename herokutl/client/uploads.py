...
def _resize_photo_if_needed(
    ...
    try:
        ...
        # See https://github.com/LonamiWebs/herokutl/issues/1121 for more.
...
class UploadMethods:
    ...
    async def send_file(
        ...
        Arguments
            ...
            file (`str` | `bytes` | `file` | `media`):
                ...
                * A Bot API-like ``file_id``. You can convert previously
                  ...
                  `herokutl.utils.pack_bot_file_id`.
            ...
            reply_to (`int` | `Message <herokutl.tl.custom.message.Message>`):
        ...
        Returns
            The `Message <herokutl.tl.custom.message.Message>` (or messages)
    ...
    async def upload_file(
        ...
        Returns
            ...
            `InputSizedFile <herokutl.tl.custom.inputsizedfile.InputSizedFile>`
