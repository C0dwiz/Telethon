...
class MessageMethods:
    ...
    def iter_messages(
        ...
        Arguments
            ...
            reply_to (`int`, optional):
                ...
                will result in ``herokutl.errors.PeerIdInvalidError`` to occur.
        ...
        Yields
            Instances of `Message <herokutl.tl.custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from herokutl.tl.types import InputMessagesFilterPhotos
    ...
    async def get_messages(
        ...
        `TotalList <herokutl.helpers.TotalList>` instead.
        ...
        a single `Message <herokutl.tl.custom.message.Message>` will be
    ...
    async def send_message(
        ...
        See also `Message.respond() <herokutl.tl.custom.message.Message.respond>`
        and `Message.reply() <herokutl.tl.custom.message.Message.reply>`.

        Arguments
            entity (`entity`):
                To who will it be sent.

            message (`str` | `Message <herokutl.tl.custom.message.Message>`):
            ...
            reply_to (`int` | `Message <herokutl.tl.custom.message.Message>`, optional):
            ...
            parse_mode (`object`, optional):
                ...
                <herokutl.client.messageparse.MessageParseMethods.parse_mode>`
            ...
            buttons (`list`, `custom.Button <herokutl.tl.custom.button.Button>`, :tl:`KeyboardButton`):
            ...
            comment_to (`int` | `Message <herokutl.tl.custom.message.Message>`, optional):
                Similar to ``reply_to``, but replies in the linked group of a
                broadcast channel instead (effectively leaving a "comment to"
                the specified message).

                This parameter takes precedence over ``reply_to``. If there is
                no linked chat, `herokutl.errors.sgIdInvalidError` is raised.
        ...
        Returns
            The sent `custom.Message <herokutl.tl.custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from herokutl import events, Button
    ...
    async def forward_messages(
        ...
        See also `Message.forward_to() <herokutl.tl.custom.message.Message.forward_to>`.

        Arguments
            entity (`entity`):
                To which entity the message(s) will be forwarded.

            messages (`list` | `int` | `Message <herokutl.tl.custom.message.Message>`):
        ...
        Returns
            The list of forwarded `Message <herokutl.tl.custom.message.Message>`,
    ...
    async def edit_message(
        ...
        See also `Message.edit() <herokutl.tl.custom.message.Message.edit>`.

        Arguments
            entity (`entity` | `Message <herokutl.tl.custom.message.Message>`):
            ...
            message (`int` | `Message <herokutl.tl.custom.message.Message>` | `str`):
                The ID of the message (or `Message
                <herokutl.tl.custom.message.Message>` itself) to be edited.
                If the `entity` was a `Message
                <herokutl.tl.custom.message.Message>`, then this message
                will be treated as the new text.

            text (`str`, optional):
                The new text of the message. Does nothing if the `entity`
                was a `Message <herokutl.tl.custom.message.Message>`.
        ...
        Returns
            The edited `Message <herokutl.tl.custom.message.Message>`,
    ...
    async def delete_messages(
        ...
        See also `Message.delete() <herokutl.tl.custom.message.Message.delete>`.
        ...
        Arguments
            ...
            message_ids (`list` | `int` | `Message <herokutl.tl.custom.message.Message>`):
    ...
    async def send_read_acknowledge(
        ...
        See also `Message.mark_read() <herokutl.tl.custom.message.Message.mark_read>`.

        Arguments
            entity (`entity`):
                The chat where these messages are located.

            message (`list` | `Message <herokutl.tl.custom.message.Message>`):
    ...
    async def pin_message(
        ...
        See also `Message.pin() <herokutl.tl.custom.message.Message.pin>`.

        Arguments
            entity (`entity`):
                The chat where the message should be pinned.

            message (`int` | `Message <herokutl.tl.custom.message.Message>`):
    ...
    async def unpin_message(
        ...
        See also `Message.unpin() <herokutl.tl.custom.message.Message.unpin>`.
