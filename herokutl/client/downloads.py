...
class DownloadMethods:
    ...
    async def download_media(
        ...
        See also `Message.download_media() <herokutl.tl.custom.message.Message.download_media>`.

        Arguments
            message (`Message <herokutl.tl.custom.message.Message>` | :tl:`Media`):
    ...
    async def download_file(
        ...
        Arguments
            input_location (:tl:`InputFileLocation`):
                ...
                See `herokutl.utils.get_input_location` source for a complete
