        ...
        for d in r.dialogs:
            ...
            if peer_id not in self.seen:
                ...
                if peer_id not in entities:
                    ...
                    # Real world example: https://t.me/herokutlChat/271471
                    continue
...
class DialogMethods:
    ...
    def iter_dialogs(
        ...
        Yields
            Instances of `Dialog <herokutl.tl.custom.dialog.Dialog>`.
    ...
    def iter_drafts(
        ...
        Yields
            Instances of `Draft <herokutl.tl.custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <herokutl.tl.custom.dialog.Dialog.delete>`.
    ...
    def conversation(
        ...
        """
        Creates a `Conversation <herokutl.tl.custom.conversation.Conversation>`
        ...
        Arguments
            ...
            replies_are_responses (`bool`, optional):
                ...
                <herokutl.tl.custom.conversation.Conversation.get_response>`
                and a subsequent call to `conv.get_reply
                <herokutl.tl.custom.conversation.Conversation.get_reply>`
        ...
        Returns
            A `Conversation <herokutl.tl.custom.conversation.Conversation>`.
