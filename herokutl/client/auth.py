...
class AuthMethods:
    ...
    async def sign_up(
        ...
        See `issue #4050 <https://github.com/LonamiWebs/herokutl/issues/4050>`_ for context.
        """
        raise ValueError('Third-party applications cannot sign up for Telegram. See https://github.com/LonamiWebs/herokutl/issues/4050 for details')
    ...
    async def qr_login(self: 'TelegramClient', ignored_ids: typing.List[int] = None) -> custom.QRLogin:
        ...
        Example
            .. code-block:: python
                ...
                # If you have 2FA enabled, `wait` will raise `herokutl.errors.SessionPasswordNeededError`.
    ...
    async def edit_2fa(
        ...
        Example
            .. code-block:: python
                ...
                await client.edit_2fa(new_password='I_<3_herokutl')

                # Removing the password
                await client.edit_2fa(current_password='I_<3_herokutl')
        """
