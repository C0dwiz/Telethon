...
class UpdateMethods:
    ...
    def add_event_handler(
        ...
        Arguments
            callback (`callable`):
                ...
                Note that if you have used `herokutl.events.register` in
            ...
            event (`_EventBuilder` | `type`, optional):
                ...
                If left unspecified, `herokutl.events.raw.Raw` (the
    ...
    async def _update_loop(self: 'TelegramClient'):
        ...
        try:
            ...
            self._log[__name__].exception(f'Fatal error handling updates (this is a bug in herokutl v{__version__}, please report it)')
            self._updates_error = e
            await self.disconnect()
