...
class ChatMethods:
    ...
    def iter_participants(
        ...
        Example
            .. code-block:: python
                ...
                # Filter by admins
                from herokutl.tl.types import ChannelParticipantsAdmins
    ...
    def iter_admin_log(
        ...
        *all* event types will be returned. If at least one of them is
        ...
        Yields
            Instances of `AdminLogEvent <herokutl.tl.custom.adminlogevent.AdminLogEvent>`.
    ...
    async def kick_participant(
        ...
        Returns
            Returns the service `Message <herokutl.tl.custom.message.Message>`
    ...
    async def get_permissions(
        ...
        Returns
            A `ParticipantPermissions <herokutl.tl.custom.participantpermissions.ParticipantPermissions>`
    ...
    async def get_stats(
        ...
        Raises
            ...
            ``herokutl.errors.ChatAdminRequiredError`` will appear.
