...
class ChatGetter(abc.ABC):
    ...
    def chat(self):
        ...
        If you're using `herokutl.events`, use `get_chat()` instead.
        """
        return self._chat
    ...
    def input_chat(self):
        ...
        <herokutl.tl.custom.sendergetter.SenderGetter.input_sender>`, this
    ...
    def is_private(self):
        ...
        (e.g. on `events.MessageDeleted <herokutl.events.messagedeleted.MessageDeleted>`).
        """
