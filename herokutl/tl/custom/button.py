...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <herokutl.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <herokutl.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.EntityLike`):
                ...
                .. note::
                    ...
                    <herokutl.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None):
        ...
        <herokutl.events.newmessage.NewMessage>`. You cannot distinguish
