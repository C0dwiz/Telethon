...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <herokutl.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <herokutl.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <herokutl.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `TelegramClient <herokutl.client.telegramclient.TelegramClient>`
    ...
    def forward(self):
        """
        The `Forward <herokutl.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <herokutl.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <herokutl.tl.custom.file.File>` wrapping the
        ...
        `file.id <herokutl.tl.custom.file.File.id>`,
        `file.name <herokutl.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from herokutl.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `herokutl.client.telegramclient.TelegramClient` instance directly.
        """
        if self._client:
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `herokutl.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `herokutl.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <herokutl.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <herokutl.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <herokutl.tl.types.PollAnswer>` argument.
