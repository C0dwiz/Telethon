...
class MessageButton:
    ...
    .. note::
        ...
        <herokutl.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `herokutl.client.telegramclient.TelegramClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None):
        ...
        sent, and the sent `Message <herokutl.tl.custom.message.Message>` returned.
