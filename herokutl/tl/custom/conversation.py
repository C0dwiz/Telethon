...
class Conversation(ChatGetter):
    ...
    async def send_message(self, *args, **kwargs):
        ...
        for `herokutl.client.messages.MessageMethods.send_message` with
        ``entity`` already set.
        """
    ...
    async def send_file(self, *args, **kwargs):
        ...
        for `herokutl.client.uploads.UploadMethods.send_file` with
        ``entity`` already set.
        """
    ...
    def get_response(self, message=None, *, timeout=None):
        ...
        Args:
            message (`Message <herokutl.tl.custom.message.Message>` | `int`, optional):
