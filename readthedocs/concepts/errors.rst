...
You should import the errors from ``herokutl.errors`` like so:
...
All the "base" errors are listed in :ref:`herokutl-errors`.
...
.. code-block:: text
    ...
    herokutl.errors.rpcbaseerrors.BadRequestError: RPCError 400: MESSAGE_POLL_CLOSED (caused by SendVoteRequest)
...
You can refer to all errors from Python through the ``herokutl.errors``
...
.. _list of known errors: https://github.com/LonamiWebs/herokutl/blob/v1/herokutl_generator/data/errors.csv
.. _raw API page: https://tl.herokutl.dev/
.. _messages.sendMessage: https://tl.herokutl.dev/methods/messages/send_message.html
