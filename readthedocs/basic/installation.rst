...
herokutl is a Python library, which means you need to download and install
...
.. code-block:: sh
    ...
    python3 -m pip install --upgrade herokutl
...
.. code-block:: sh
    ...
    python3 -m pip install --upgrade https://github.com/LonamiWebs/herokutl/archive/v1.zip
...
.. __: https://github.com/LonamiWebs/herokutl/issues/
...
.. code-block:: sh
    ...
    python3 -c "import herokutl; print(herokutl.__version__)"
...
.. note::
    ...
    .. code-block:: sh
        ...
        pip install -U --user herokutl cryptg pillow
