...
.. code-block:: python
    ...
    async def main():
        ...
        await client.send_message('username', 'Testing herokutl!')
...
.. important::
    ...
    Note that herokutl is an asynchronous library, and as such, you should
    ...
    After you understand this, you may use the ``herokutl.sync`` hack if you
