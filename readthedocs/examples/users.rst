...
.. code-block:: python
    ...
    await client(UpdateProfileRequest(
        about='This is a test from herokutl'
    ))
...
.. code-block:: python
    ...
    from herokutl.tl.functions.account import UpdateUsernameRequest
...
.. code-block:: python
    ...
    from herokutl.tl.functions.photos import UploadProfilePhotoRequest
