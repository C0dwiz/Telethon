...
.. important::
    ...
    <herokutl.tl.custom.chatgetter.ChatGetter>`! Please see :ref:`faq`
...
<herokutl.events.newmessage.NewMessage>`.
...
<herokutl.events.newmessage.NewMessage>`, you should treat
this event as a `Message <herokutl.tl.custom.message.Message>`.

Full documentation for the `MessageEdited
<herokutl.events.messageedited.MessageEdited>`.
...
<herokutl.events.messagedeleted.MessageDeleted>`.
...
<herokutl.events.messageread.MessageRead>`.

.. currentmodule:: herokutl.events.messageread.MessageRead.Event
...
.. currentmodule:: herokutl.events.chataction.ChatAction.Event
...
<herokutl.events.userupdate.UserUpdate>`.

.. currentmodule:: herokutl.events.userupdate.UserUpdate.Event
...
.. currentmodule:: herokutl.events.callbackquery.CallbackQuery.Event
...
<herokutl.events.inlinequery.InlineQuery>`.

.. currentmodule:: herokutl.events.inlinequery.InlineQuery.Event
...
<herokutl.events.album.Album>`.

.. currentmodule:: herokutl.events.album.Album.Event
