...
from herokutl.network import ConnectionTcpAbridged
...
class InteractiveTelegramClient(TelegramClient):
    """Full featured Telegram client, meant to be used on an interactive
       session to see what herokutl is capable off -

       This client allows the user to perform some basic interaction with
       Telegram through herokutl, such as listing dialogs (open chats),
